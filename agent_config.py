...
DEFAULT_AGENT_CONFIGS = {
    "reader": {
        ...
        "future_coherence_validator": {"enabled": True, "provider": "openai", "model": "o3-mini", "system_prompt": "Valida coerenza futura senza esporre spoiler.", "allowed_tools": ["tool_future_consistency_check"], "temperature": 0.0, "max_tokens": 800},
